// This is the complete implementation of the deepResearch tool using the four-agent pipeline
// To be inserted into app/(chat)/api/chat/route.ts

export const deepResearchToolImplementation = `
          deepResearch: {
            description:
